...
class UserBase(BaseModel):
    ...
    cash_balance_usd: float = Field(0.0, ge=0, description="Total cash balance available for CASSIE jobs")
    cash_reserved_usd: float = Field(0.0, ge=0, description="Balance currently reserved for active jobs")
    cash_available_usd: float = Field(0.0, ge=0, description="Balance that can be reserved for new jobs")
